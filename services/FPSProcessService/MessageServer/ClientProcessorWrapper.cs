...
{
    [Serializable()]
	public abstract class ClientProcessorWrapper
	{
        ...
        public delegate void DProcessMsg(byte[] message, ClientSocketWrapper socket);
        public delegate void DProcessHeader(byte[] header, ClientSocketWrapper socket);
		#endregion
        ...
        public delegate void DProcessMsgS(string message, ClientSocketWrapper socket);
		#endregion
        ...
        public virtual void ProcessMsg(byte[] message, ClientSocketWrapper socket)
		{
		}
		...
		/// <param name="message">The final complete message, as agreed by IsEOF</param>
		/// <param name="socket">The connected socket to communicate on</param>
		public virtual void ProcessMsg(string message, ClientSocketWrapper socket)
		{
		}
        ...
        /// <param name="message">The final complete message, as agreed by IsEOF</param>
        /// <param name="socket">The connected socket to communicate on</param>
        public virtual void ProcessHeader(byte[] header, ClientSocketWrapper socket)
        {
        }
		...
		/// </summary>
		/// <param name="socket">The connected socket to communicate on</param>
        public virtual void StartConversation(ClientSocketWrapper socket)
		{
			_sendHello(socket);
			socket.Receive();
		}

		private void _sendHello(ClientSocketWrapper socket)
		{
			socket.Send("HELLO\r\n");
		}
