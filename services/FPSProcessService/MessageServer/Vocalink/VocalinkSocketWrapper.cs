...
{
    public class VocalinkSocketWrapper : SocketWrapper
    {
        ...
        public VocalinkSocketWrapper(Socket baseSocket, ProcessorWrapper.DEOFLengthCheck eofFn, ProcessorWrapper.DProcessHeader headerFn, ProcessorWrapper.DProcessMsg proFn, TCPSettings settings)
        {
