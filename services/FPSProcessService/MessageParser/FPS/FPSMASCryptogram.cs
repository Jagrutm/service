...
namespace Contis.MessageParser.FPS
{
    public class FPSMASCryptogram : VSDCChip
    {
        public FPSMASCryptogram() { }

        public int DerivationKeyIndex { get; set; } = 0;

        //public FPSMASCryptogram(string cryptogram, DataElementList dataElementList)
        //{
